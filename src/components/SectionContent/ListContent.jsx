...
const ListContent = () => {
  ...
  return (
    <div className='w-[85%]'>
      <div className="xl:w-[1200px] w-full h-[1187px] pt-16 sm:px-12 md:px-0">
        ...
        <div className="md:flex flex-wrap justify-between 2xl:justify-around lg:w-full content-start h-[870px] overflow-y-scroll sm:pl-0 pl-28">
