      ...
      {isMobile ?
        <div className="footer w-full h-[129px] items-center p-4 text-neutral-content bg-gray-400">
          <div className="items-center grid-flow-col">
            ...
            <p className="text-lg">Copyright © 2022 - All right reserved by HN</p>
            <a
              href="https://github.com/orgs/who-community/repositories"
              target="_blank"
            >
              <AiFillGithub className="w-[37px] h-[37px]" />
            </a>
          </div>
        </div>
