  ...
  return (
    <div>
      <Link to={`/detail/${questionId}`}>
        <div className="flex items-center justify-around sm:justify-between w-[100%] sm:w-[370px] h-[80%] sm:h-[230px] bg-white rounded-3xl drop-shadow-xl xl:ml-20 lg:ml-0 mb-20 ">
